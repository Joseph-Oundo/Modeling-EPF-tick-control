...
#Source files for generating figure 4
...
run.model.by.treatment.interval.decay.and.coverage <- function(coverage_level, treatment.interval, treatment.decay, time, initial.state, param){
